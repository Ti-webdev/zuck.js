      ...
      var ZuckJS = function ZuckJS(timeline, options) {
        ...
        var playVideoItem = function playVideoItem(elements, unmute) {
          ...
          if (itemElement.getAttribute("data-type") == "video") {
            ...
            var setDuration = function setDuration(e) {
              if (e) {
              }
              if (video.duration) {
                setVendorVariable(
            ...
            var isPausedWhileLoading = true
            var setVideoLoading = function setVideoLoading() {
              isPausedWhileLoading = true
              setVendorVariable(
                itemPointer.getElementsByTagName("b")[0].style,
                "AnimationPlayState",
                "paused"
            ...
            // video.onready = video.onload = video.onplaying = video.oncanplay = function(e) {
            //   addMuted(video);
            //
            //   storyViewer.classList.remove("loading");
            // };
